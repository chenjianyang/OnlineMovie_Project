...
function handleResult(resultData) {
    ...
    starInfoElement.append("<p>Movie Title: " + resultData[0]["movieTitle"] + "</p>" +
        ...
        + '<a href="index.html?mode=2&browse=' + resultData[0]['gen1'] + '&sort=1&num=20' + '">' + tempG1 + '</a>'
        + '<a href="index.html?mode=2&browse=' + resultData[0]['gen2'] + '&sort=1&num=20' + '">' + tempG2 + '</a>'
        + '<a href="index.html?mode=2&browse=' + resultData[0]['gen3'] + '&sort=1&num=20' + '">' + tempG3 + '</a>'
        + "</font></p>"
