...
function handleListResult(resultData) {
    ...
    for (let i = 0; i < Math.min(105, resultData.length); i++) {
        ...
        rowHTML += "<th>"
            + '<a href="index.html?mode=2&browse=' + resultData[i]['gen1'] + '&sort=1&num=20' + '">' + tempG1 + '</a>'
            + '<a href="index.html?mode=2&browse=' + resultData[i]['gen2'] + '&sort=1&num=20' + '">' + tempG2 + '</a>'
            + '<a href="index.html?mode=2&browse=' + resultData[i]['gen3'] + '&sort=1&num=20' + '">' + tempG3 + '</a>'
            + "</th>";
        rowHTML += "<th>"
